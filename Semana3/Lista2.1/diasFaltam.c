...
int main(){
    ...
    if(ano1<ano2){ //compensar shift inicial, comeca em ano diferente
        bissexto = (ano1%4==0 && ano1%100!=0) || ano1%400==0; //checar se ano1 é bissexto
        while(mes1Temp<=12){ // compensar ano que comeca
            diasFaltam+=((28+bissexto)*(mes1Temp==2) + (mes1Temp%2==0 && mes1Temp<8?30:31)*(mes1Temp<8 && mes1Temp!=2)+(mes1Temp%2==0 && mes1Temp>=8?31:30)*(mes1Temp>=8))-dia1;
            dia1=0;
            mes1Temp++; //sai como 1
        }
        ...
        diasFaltam+=dia2-dia1; // se mesmo ano e mes, note que para os outros casos dia1=0
    }
    printf("%d",diasFaltam);
}
